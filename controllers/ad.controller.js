...
adController.createAd = async (req, res) => {
  try {
    ...
    return res.success(httpStatus.CREATED, true, "Ad created successfully", ad);
  } catch (error) {
...
adController.getAllAds = async (req, res) => {
  try {
    ...
    return res.success(httpStatus.OK, true, "Ads fetched successfully", ads);
  } catch (error) {
...
adController.updateAd = async (req, res) => {
  try {
    ...
    return res.success(httpStatus.OK, true, "Ad updated successfully", ad);
  } catch (error) {
...
adController.deleteAd = async (req, res) => {
  try {
    ...
    return res.success(httpStatus.OK, true, "Ad deleted successfully", {
      id: adId,
    });
  } catch (error) {
